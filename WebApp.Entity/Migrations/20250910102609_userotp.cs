        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NetSpend = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReturnRequests_AspNetUsers_ApprovedBy",
                        column: x => x.ApprovedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReturnRequests_AspNetUsers_ReceivedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseItemId = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    RefundLineTotal = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Menus",
                columns: new[] { "MenuId", "Name", "Path" },
                values: new object[,]
                {
                    { 1, "Product Catalog", "/catalog" },
                    { 2, "Customer Dashboard", "/customer/dashboard" },
                    { 3, "Cart", "/cart" },
                    { 4, "Purchase History", "/purchase-history" },
                    { 5, "Admin Dashboard", "/admin/dashboard" },
                    { 6, "Return Requests", "/admin/returns" },
                    { 7, "Product Management", "/admin/products" },
                    { 8, "Reporting Dashboard", "/admin/reports" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReturnRequests_ApprovedBy",
                table: "ReturnRequests",
                column: "ApprovedBy");

            migrationBuilder.CreateIndex(
                name: "IX_ReturnRequests_ReceivedBy",
                table: "ReturnRequests",
                column: "ReceivedBy");
