...
namespace WebApp.Api.Repositories
{
    public class DashboardRepository : IDashboardRepository
    {
        ...
        {
            { UserBadge.Bronze, 0m },
            { UserBadge.Silver, 1000m },
            { UserBadge.Gold, 5000m },
            { UserBadge.Platinum, 10000m }
        };
        ...
        public async Task<AdminDashboardDto> GetAdminDashboardAsync()
        {
            ...
            // Refund amount: sum of ReturnItem.RefundLineTotal OR ReturnRequest.RefundAmount when set
            ...
            // choose max of both or sum depending on how you record refunds; we'll sum them but avoid double counting if both used.
            // If you use only ReturnItems -> keep totalRefundFromItems; if you set RefundAmount on ReturnRequest -> keep totalRefundRequests.
            // To be safe, use totalRefundFromItems (since per-line) and fallback to ReturnRequest totals if items are zero.
